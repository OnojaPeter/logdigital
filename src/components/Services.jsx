        ...
        <div className="max-w-[1400px] mx-auto ">       
          ...
          variants={sectionAnimation.variants} 
           className="flex flex-col items-center md:text-center px-4 md:px-8 lg:px-16">
            ...
            <p className="text-lg md:text-xl  md:mx-24 lg:mx-40 font-bold text-gray-800">Lorem ipsum, dolor sit amet dolorem eligendi iusto harum beatae consectetur adipisicing elit. Sit odit, voluptas deleniti dolorem eligendi iusto harum beatae !</p>
          </motion.div>
