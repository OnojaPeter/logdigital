        ...
        <section>
          <div className="max-w-[1400px] mx-auto px-4 md:px-8 lg:px-16 pb-8 md:pb-14">
            <div className="py-8 md:py-14">
              <h1 className="uppercase text-3xl md:text-4xl font-semibold text-center">About Us</h1>
            </div>
            
            <div className="flex flex-col gap-5 text-lg font-medium text-gray-600">
              <p>
                At LOG DIGITAL, we are at the forefront of technological innovation, offering a comprehensive suite of
                ...
                enhance your cybersecurity measures, or leverage the power of cloud computing, LOG DIGITAL has the
                expertise and resources to help you achieve your goals.
                By partnering with LOG DIGITAL, you gain access to state-of-the-art technology and personalized
              ...
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorum magni repellendus sit reiciendis est vel nobis? 
